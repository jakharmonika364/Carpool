...
dashboard, analytics, Kubernetes, and production cloud deployment. These depend on the
foundation shipped here and land in later months — see the [project README](../README.md) for
the overall product vision they build toward.

## Acceptance criteria

See "What's implemented vs. placeholder" in [`getting-started.md`](getting-started.md) — it is
treated as the authoritative Month 1 checklist.
