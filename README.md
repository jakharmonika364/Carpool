# Campus Carpool — Month 1 Foundation

A campus ride-sharing app. This repository contains the **Month 1 foundation**: architecture,
database schema, a NestJS backend with authentication and profile management, a React Native
mobile scaffold, and the local dev/CI setup they run on.

Full ride creation, matching, chat, live tracking, and payments are **not** implemented yet —
see [`docs/requirements.md`](docs/requirements.md) for the complete scope and what's deferred.
...
Docs: [requirements](docs/requirements.md) · [architecture](docs/architecture.md) ·
[ERD](docs/erd.md) · [API routes](docs/api-spec.md)
...
See [`docs/api-spec.md`](docs/api-spec.md) for the full route list.
